...
export const Route = createFileRoute("/docs/endpoints/positions")({
  head: () => ({ meta: [{ title: "Positions endpoints — CopyPools docs" }, { name: "description", content: "List, detail, and reconstructed chart endpoints for Uniswap v4 positions." }] }),
  component: () => (
    <div className="space-y-6">
      ...
      <CodeBlock code={`curl https://api.copypools.io/v1/positions?chain=ethereum&sort=apr.desc&limit=25 -H "KC-APIKey: …"`} />
