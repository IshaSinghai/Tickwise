...
export const Route = createFileRoute("/docs/endpoints/pools")({
  head: () => ({ meta: [{ title: "Pools endpoints — CopyPools docs" }, { name: "description", content: "List and detail endpoints for Uniswap v4 pools." }] }),
  component: () => (
    <div className="space-y-6">
      ...
      <CodeBlock code={`curl https://api.copypools.io/v1/pools?chain=ethereum&sort=tvl.desc -H "KC-APIKey: …"`} />
