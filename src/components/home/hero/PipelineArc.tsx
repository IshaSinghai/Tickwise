    ...
    >
      {STAGES.map((s, i) => {
        ...
        return (
          <motion.span
            key={s.label}
            className="absolute whitespace-nowrap rounded-full border border-primary/30 bg-surface/50 px-2 py-0.5 font-mono text-[9px] uppercase tracking-[0.18em] text-muted-foreground backdrop-blur-xl"
