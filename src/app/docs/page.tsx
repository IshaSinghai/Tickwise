    ...
    <div className="prose prose-invert max-w-none space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          A metered read API for Uniswap v4 pools and positions on Ethereum and Avalanche. One
          header of auth, near-real-time data, honest quotas. If a page says something we don’t do,
          treat that as a bug.
        </p>
      </div>
      ...
      <div>
        ...
        <ol className="ml-5 list-decimal space-y-2 text-sm text-muted-foreground">
          ...
          <li>
            Head to <span className="font-mono">/portal/keys</span> and create a <em>server key</em>
            .
          </li>
        ...
        <CodeBlock
          code={`curl https://api.tickwise.io/v1/pools?chain=ethereum \\\n  -H "KC-APIKey: kc_live_…"`}
        />
      </div>
        ...
        <ul className="grid gap-3 md:grid-cols-2">
          {[
            ...
            [
              ...
              "Units & limits",
              "What a unit is, per-endpoint costs, 429s",
            ],
            ...
            <li key={to}>
              <Link
                href={to}
                className="block rounded-xl border border-border/60 bg-surface p-4 transition-colors hover:border-primary/40"
              >
