    ...
    <div className="prose prose-invert max-w-none space-y-6">
      ...
      <div>
        ...
        <ol className="ml-5 list-decimal space-y-2 text-sm text-muted-foreground">
          <li><Link href="/signup" className="text-primary hover:underline">Create a free account</Link>.</li>
      ...
      <div>
        ...
        <ul className="grid gap-3 md:grid-cols-2">
          {[
            ...
            <li key={to}>
              <Link href={to} className="block rounded-xl border border-border/60 bg-surface p-4 transition-colors hover:border-primary/40">
