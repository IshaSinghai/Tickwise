...
export const metadata: Metadata = {
  title: "Coverage — Tickwise docs",
  description: "Chains and protocols supported today, and what’s on the roadmap.",
};
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        We list only what’s truly servable. Indexed-but-not-servable chains are marked as such so
        you don’t plan around them.
      </p>
            ...
            {[
              ...
              <tr key={c}>
                ...
                <td className="px-4 py-2">
                  <span
                    className={`rounded-full px-2 py-0.5 text-xs ${s === "live" ? "border border-success/40 bg-success/10 text-success" : "border border-border/60 bg-surface text-muted-foreground"}`}
                  >
                    {s}
                  </span>
                </td>
